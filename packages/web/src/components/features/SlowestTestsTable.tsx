      ...
      <div className="bg-gray-800 rounded-lg shadow-lg border border-gray-700">
        ...
        <div className="p-6">
          <div className="bg-red-900/20 border border-red-700 rounded-lg p-4">
            <p className="text-red-400">Failed to load slowest tests data</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="p-6">
        <div className="space-y-1">
          {data.slowestTests.map((test, index) => (
            <div
              key={test.testName}
              className="flex justify-between items-center py-3 px-3 rounded-lg hover:bg-gray-700/50 transition-colors"
            >
